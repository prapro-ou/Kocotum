...
{
	TextureAsset(U"SavePoint").resized(CHIP_SIZE).draw(pos + Vec2{0, Periodic::Sine1_1(2s) * CHIP_SIZE.y / 16 - CHIP_SIZE.y / 4}, (isTouched ? Palette::Mediumspringgreen : Palette::Lightskyblue));
}
